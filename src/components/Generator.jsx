  ...
  return (
    <>
      ...
      >
          ...
          {Object.keys(WORKOUTS).map((type, typeIndex) => {
            return (
              <button
               ...
               border-blue-400 px-4 duration-200 hover:border-blue-600 py-3 rounded-lg ${
        ...
        <div
          className=" bg-slate-950  border
        border-solid border-blue-400 rounded-lg flex flex-col"
        >
          <button
            onClick={toggleModal}
          ...
          >
            ...
            <i
              className="fa-solid absolute right-3 top-1/2 -translate-y-1/2
            fa-caret-down"
            ></i>
          </button>
          {showModal && (
